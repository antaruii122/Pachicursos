      ...
      <header className="border-b border-[var(--linea)] bg-white">
        <div className="mx-auto flex max-w-[1100px] items-center justify-between px-6 py-4">
          <nav className="flex items-center gap-6 font-[family-name:var(--font-ui)] text-[.88rem]">
            <Link href="/admin" className="font-semibold text-[var(--vino)]">
              Panel admin
            </Link>
            <Link href="/admin" className="text-[var(--tinta-suave)] hover:text-[var(--vino)]">
              Resumen
            </Link>
            <Link href="/admin/cursos" className="text-[var(--tinta-suave)] hover:text-[var(--vino)]">
              Cursos
            </Link>
            <Link href="/admin/usuarios" className="text-[var(--tinta-suave)] hover:text-[var(--vino)]">
              Usuarios
            </Link>
          ...
          <div className="flex items-center gap-5 text-[.85rem]">
            <Link href="/cuenta/perfil" className="text-[var(--tinta-suave)] hover:text-[var(--vino)]">
              Mi perfil
            </Link>
